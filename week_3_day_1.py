...
print( name + " liked to hum the song " + song + " while coding. It was so annoying that their teammates would throw " + food + " until " + name + " would stop singning.")

# Still, [name] was the best coder on the team and could write [number] lines of code every day. Maybe [song] was [name]’s secret power?
print("Still, " + name + " was the best coder on the team and could write " + str(number) + " lines of code everyday. Maybe the " + song + " was " + name + "'s secret power?") 
...
number4 = 400
number5 = 500
# put all of these into one sentence
...
# absolute value is always the distance from 0 to the number 
#its always positive
